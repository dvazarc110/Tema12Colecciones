...
public class Exercise1 {
	...
	public void show() {
		...
		String numinf = menoresmedia(lista, media);
		lista = deletenum(lista, media);
		System.out.printf("\nLa media de los números introducidos es: %.2f", media);
		System.out.printf("\nLos números introducidos inferiores a la media son: %s", numinf);
		System.out.printf("\nEl array sin los números inferiores a la media (%.2f) son: %s", media, lista.toString());
	}
	...
	public List<Integer> deletenum(List<Integer> lista, double media){
